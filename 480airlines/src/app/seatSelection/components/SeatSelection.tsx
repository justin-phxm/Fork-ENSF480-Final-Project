      ...
      <div className="flex h-[3000px] flex-row px-4 justify-between overflow-hidden">
        ...
        <div className=" w-[550px] h-[550px]">
          ...
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="absolute left-[290px] -top-[1300px] -z-10"
          >
            <path
          ...
          {/* Seat Selection */}
          <div className=" w-64 py-4 h-96 flex flex-col absolute top-[600px] left-[295px]">
            {/* Place Front section */}
            ...
            {/* Plane back section */}
            <div className=" py-2 w-52 bg-white rounded-lg flex-col justify-start items-center gap-1 inline-flex">
              {/* Exit Row */}
        ...
        {/* <div className="w-96 h-24 pl-6 pr-96 py-5 left-0 top-0 absolute justify-start items-center gap-3 inline-flex">
          <div className="w-8 h-8 relative rounded flex-col justify-start items-start flex" />
          <div className="w-32 h-14 relative flex-col justify-start items-start flex" />
        </div> */}
      </div>
    </>
  );
